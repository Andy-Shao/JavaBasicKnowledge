...
/**
 * 
 * Descript:if the format is "java.properties", it is attribute file. If it is attribute file, Should get 
 * {@link InputStream} class and create a {@link Reader}. finally build the {@link PropertyResourceBundle}.<br>
...
public class BetterResourceControl extends ResourceBundle.Control{
	...
	public ResourceBundle newBundle(String baseName, Locale locale, String format, ClassLoader loader, boolean reload)
		...
		if("java.properties".equals(format)){
			...
			String resrourceName = toResourceName(bundleName, "properties");
			...
			if(reload){
				...
				stream = loader.getResourceAsStream(resrourceName);
			}
