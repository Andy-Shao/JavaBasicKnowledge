...
public class GetMethodHandle {
    ...
    public void lookupMethod() throws NoSuchMethodException , IllegalAccessException {
        ...
        //String.format
        lookup
            .findStatic(String.class , "format" , MethodType.methodType(String.class , String.class , Object[].class));
    }

    @Test
    public void lookupSpecial() throws NoSuchMethodException , IllegalAccessException {
        MethodHandles.Lookup lookup = MethodHandles.lookup();
        lookup.findSpecial(GetMethodHandle.class , "privateMethod" , MethodType.methodType(void.class) ,
            GetMethodHandle.class);
    }
    ...
    @Test
    public void unreflect() throws NoSuchMethodException , SecurityException , IllegalAccessException ,
