 ...
 * 
 * Descript:
 * The Files class is the other primary entrypoint of the java.nio.file package. This class offers a rich set of static 
 * methods for reading, writing, and manipulating files and directories. The Files methods work on instances of Path 
 * objects. Before proceeding to the remaining sections,
 * <br>
