/*
 * This example demonstrates how to create a JavaFX animation using the Nashorn script engine capabilities. When you run this example, a 
 * window with colorful circles moving around is shown.*/
load("fx:base.js");
load("fx:controls.js");
load("fx:graphics.js");
