...
public class InvokeMethodHandle {
    ...
    public void invoker() throws Throwable {
        ...
        Assert.assertThat(result , Matchers.is("l"));
        result = (String) invoker.invoke(mh2 , this , 2 , 3);
        Assert.assertThat(result , Matchers.is("[2, 3]"));
    }
    ...
    public void invokerTransform() throws Throwable {
        ...
        /*
         * For exactInvoker().
         * if the method handle changes, the others method handle also change
         * when the new method
        ...
        Assert.assertThat((String) invoker.invoke(mh1 , "Hello" , 1 , 4) , Matchers.is("ELL"));
    }
